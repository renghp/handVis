...
public class DataRecorderLeft :  MonoBehaviour
{
   ...
   // private OVRSkeleton.SkeletonType _skeletonTypeL;
    ...
    private List<HandSequence> _handSequenceRecordingsL;
    ...
    public void SavePlayback()
    {
            ...
            debuggerLogger.text = " * COROUTINE STARTED L*";
   ...
   /* IEnumerator WaitToChangeScene()
    ...
    {
        debuggerLogger.text = "* SAVING RECORDING *L";
